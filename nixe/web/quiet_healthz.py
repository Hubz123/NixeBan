...
def install_fastapi_quiet_healthz(app):
    ...
    if APIRouter is not None:
        ...
        try:
            ...
            try:
                app.add_route(HEALTHZ_PATH, lambda request: Response(status_code=204), methods=["GET"])  # type: ignore[attr-defined]
            except Exception:
                pass
    ...
    if BaseHTTPMiddleware is not None and StarletteResponse is not None:
        ...
        try:
            app.add_middleware(QuietHealthzMiddleware)  # type: ignore[attr-defined]
        except Exception:
            pass
